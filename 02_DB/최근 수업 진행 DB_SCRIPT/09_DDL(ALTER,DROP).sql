...
ALTER TABLE DEPT_COPY
MODIFY DEPT_TITLE NOT NULL; -- NOT NULL은 MODIFY 사용!! (기억해주세요!)
...
--ALTER TABLE DEPT_COPY DROP CONSTRAINT SYS_C009410; -- NOT NULL

-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY 
MODIFY DEPT_TITLE CONSTRAINT SYS_C009401 NULL;
...
SELECT * FROM DEPT_COPY; --> LNAME 컬럼이 추가되어있고, 컬럼 값이 모두 '한국'으로 되어있음.
...
ROLLBACK; -- 트랜잭션(DML을 이용한 데이터 변경 사항을 저장)을 삭제하고 마지막 커밋 상태로 돌아감. (TCL)
